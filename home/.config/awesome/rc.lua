...
vicious.register(batwidget, vicious.widgets.bat, "Bat: $2%", 10, "BAT0")
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    ...
                                    { "vidyo", "VidyoDesktop" },
                                    { "skype", "skype" },
                                    { "teamspeak", "/opt/teamspeak/ts3client_runscript.sh" }
                                  }
                        })
